...
public class Rss_Reader1 {
    ...
    int flag=0;    
       //readRSS("http://www.cbsnews.com/latest/rss/main","main");
       readRSS("http://www.cbsnews.com/latest/rss/politics","Politics");
      //readRSS("http://www.cbsnews.com/latest/rss/world","World");
      // readRSS("http://www.cbsnews.com/latest/rss/tech","tech");
      // readRSS("http://www.cbsnews.com/latest/rss/health","health");
     //  readRSS("http://www.cbsnews.com/latest/rss/entertainment","entertainment");
     //  readRSS("http://www.cbsnews.com/latest/rss/scitech-gamecore","game");
    }
    
   
    public static void readRSS(String urlAddress,String type)
    { String temp1 = null,temp2=null,temp3=null,temp4=null,temp5=null;      
        try{
            ...
            String line;
            int i=1;
            System.out.println("Type of news::"+type);
            while(i<=2)
            {
            while((line=in.readLine())!=null)
            {
                ...
                {
                    int firstPos=line.indexOf("<image>");
                    temp3=line.substring(firstPos);
                    temp3=temp3.replace("<image>","");
                    int lastPos=temp3.indexOf("</image>");
                ...
                {
       data(temp1,temp2,temp3,temp4,temp5,type); 
                }
            }
    ...
    public static void data(String title,String desc,String image,String date,String link,String type)
    {
