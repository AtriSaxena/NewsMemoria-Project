...
$start_from = ($page-1) * 12;
		$sql1="select id from rss_data where category_data='World' order by id DESC LIMIT $start_from,12";
...
$sqli = "SELECT COUNT(id) FROM rss_data where category_data='world'"; 
...
for ($i=1; $i<=$total_pages; $i++) { 
    ...
    echo "<a href='all_world.php?page=".$i."'>".$i."</a> "; 
}; 
